...
public class FetchWithFunction {

    public static String fetchPageSourcefromClientGoogle(URI newurl, String refer, List<ProxyImport> proxyList) throws IOException, InterruptedException {
...
//            httpget.addHeader("Cookie", "f5avrbbbbbbbbbbbbbbbb=JMPPPJMFICFNMADHCMHMJBCLDHKNJALHDHGMLMJPPGADCPEAJLGECMHOKFMAIFKADOIDHKCNHIDDIGLLCDCDADNIHMLBMGIFOBHJNBIIHAHKPMEFBPKELCDFHAJPFDOF");
            httpget.addHeader("Cookie", "f5avrbbbbbbbbbbbbbbbb=JMPPPJMFICFNMADHCMHMJBCLDHKNJALHDHGMLMJPPGADCPEAJLGECMHOKFLOIFKADOIDHKCNHIDDIGLLCDCDADNIHMLBMGIFOBHJNBIIHAHKPMEFBPKELCDFHAJPFDOF");
            ...
            if (responsestatus.contains("503") || responsestatus.contains("502") || responsestatus.contains("403")
                ...
                do {
                    count++;
                    responsebody = fetchPageSourcefromClientGoogleSecond(newurl, refer, proxyList);
...
//                    responsebody = fetchPageSourcefromClientGoogleSecond(newurl);
    ...
    public static String fetchPage(URI newurl, String refer, List<ProxyImport> proxyList) throws IOException, InterruptedException {
...
//                    responsebody = fetchPageSourcefromClientGoogleSecond(newurl);
    ...
    public static String fetchPageSourcefromClientGoogleSecond(URI newurl, String refer, List<ProxyImport> proxyList) throws IOException {
